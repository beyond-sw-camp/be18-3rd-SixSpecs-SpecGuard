...
<main class="mx-auto max-w-6xl px-6 py-12">
    ...
    <section class="col-span-12 md:col-span-7">
        ...
        <div class="mt-3 grid grid-cols-2 gap-3">
            <button
            class="inline-flex items-center justify-center gap-2 rounded-md bg-white px-3 py-2 text-sm font-medium ring-1 ring-slate-200 shadow-sm"
            >
            <img alt="Google" class="h-4 w-4" src="https://www.svgrepo.com/show/475656/google-color.svg" />
            Continue with Google
            </button>
            <button
            class="inline-flex items-center justify-center gap-2 rounded-md bg-[#03C75A] px-3 py-2 text-sm font-medium text-white shadow-sm"
            >
