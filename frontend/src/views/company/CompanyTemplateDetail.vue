    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <section class="space-y-4">
            ...
            <div class="grid grid-cols-12 gap-5 p-5">
                ...
                <img :src="a.avatarUrl || fallbackAvatar" alt=""
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-slate-700">검증 상태: <span class="font-semibold">완료</span></p>
                    <p class="mt-1 text-slate-700">정합성 점수: <span class="font-extrabold">{{ fmtScore(a.score) }}</span></p>
                    ...
                    <button class="rounded-md border bg-white px-3 py-1 hover:bg-slate-50" @click="reverify(a.id)">다시 검증하기</button>
                    </div>
                </div>
                </div>
...
async function fetchTemplateDetail(id) {
    ...
    try {
        ...
        avatarUrl: x.avatarUrl || x.profileImageUrl || fallbackAvatar,
